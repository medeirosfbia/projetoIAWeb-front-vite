                                ...
                                <div className="max-w-2xl mx-auto ">
                                    <div className="bg-white shadow-md border border-gray-200 rounded-lg sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <form className="space-y-6 p-10" onSubmit={submitNewAdmin} >
                                                ...
                                                <input type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-500 dark:bg-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder={user.email}
                                                    value={emailUserType}
                                                    name="email"
